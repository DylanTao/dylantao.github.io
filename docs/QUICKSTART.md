...
> **Video Tutorial:** The upstream [al-folio repository](https://github.com/alshedivat/al-folio) hosts a walkthrough video of these steps; this fork no longer ships the 26 MB file.
