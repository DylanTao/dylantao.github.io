...
- `account_lifetime` is the canonical whole-account counter. Refresh it from authenticated Codex account activity at `GET /wham/profiles/me`, preserve the response timestamp, and mark the current calendar day partial when applicable.
