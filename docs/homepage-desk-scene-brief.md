...
- Current interaction priority: the interior room view should stay pinned to a centered room vantage with only a modest yaw/pitch range. Do not let normal room dragging swing the camera around to exterior-looking-in angles; reserve broader orbiting for the deliberate outside view.
...
- Interior drag stays within a centered room-view range and cannot orbit behind the window/exterior shell.
