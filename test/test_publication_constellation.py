...
class PublicationConstellationContractTest(unittest.TestCase):
    ...
    def test_origin_routes_and_reproduction_artifact_are_real_and_semantic(self) -> None:
        ...
        self.assertIn('class="widget-origin-glint"', origin_include)
        self.assertIn('class="widget-origin-glint-core"', origin_include)
        self.assertNotIn('class="widget-origin-word"', origin_include)
        self.assertNotIn('class="widget-origin-arrow"', origin_include)
        self.assertNotIn('class="widget-origin-tooltip"', origin_include)
        self.assertNotIn('<svg', origin_include)
