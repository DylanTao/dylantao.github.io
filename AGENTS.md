...
- **Syncing upstream al-folio?** → Read [`.codex/skills/al-folio-upstream-sync/SKILL.md`](.codex/skills/al-folio-upstream-sync/SKILL.md) first (merge workflow, conflict policy, validation)
